...
__used __section(__versions) = {
	...
	{ 0x2d900eb2, "nvme_init_request" },
	{ 0x89c142d0, "nvme_wait_reset" },
	...
	{ 0x87b8798d, "sg_next" },
	{ 0x2f74fa57, "nvme_mark_namespaces_dead" },
	...
	{ 0xb37f88f9, "nvme_try_sched_reset" },
	...
	{ 0xe32b4022, "nvme_remove_namespaces" },
	...
	{ 0x885de096, "_dev_err" },
	{ 0x33e389ac, "nvme_dev_attrs_group" },
	{ 0x42160169, "flush_workqueue" },
	{ 0xf94cd7b4, "nvme_fail_nonready_command" },
	{ 0x9c332cd7, "disk_to_nvme_ns" },
	...
	{ 0x1270ac54, "nvme_submit_sync_cmd" },
